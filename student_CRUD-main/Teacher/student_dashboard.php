            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        // Construct student card HTML for approved student
                        studentCard += '<div class="student-info">';
                        studentCard += '<h3>' + student.first_name + ' ' + student.middle_name + ' ' + student.last_name + '</h3>';
                        studentCard += '<p><strong>ID Number:</strong> ' + student.id_number + '</p>';
                        studentCard += '<p><strong>Email:</strong> ' + student.email + '</p>';
                        studentCard += '<p><strong>Age:</strong> ' + student.current_age + '</p>';
                        ...
                        if (approveStatus == 1) {
                            studentCard += '<p><strong>Approve:</strong> Yes</p>';
                            ...
                            studentCard += '<p><strong>Approve:</strong> No</p>';
                        }
                        studentCard += '</div>';
